      ...
      <script>
        $(document).ready(function () {
            ...
            productXmlNodes = (productXml) => {
              let idXml = productXml.getElementsByTagName("id")[0].childNodes[0].nodeValue;
              ...
              cartUptodate = (title,image,price) => {
                productImage = '"background-image: url(../images/products/' + image + ')"';
                document.querySelector('#cartWindow #products').innerHTML += `
                <div class="product">
                  ...
                  <div class="details">
                    ...
                    <span class="info">Total: <span></span> EGP</span>
                  </div>
                </div>
                `;
              }
              ...
              productNode.querySelector(".add").addEventListener("click", () => {
                $.ajax({
                  ...
                  success: function (response) {
                    ...
                    cartUptodate(titleXml,imageXml,priceXml);
                  }
                });
              });
